...
class BaseConfig(BaseSettings):
    ...
    telegram_webhook_url: Optional[str] = Field(
        default=None,
        description="Full webhook URL (will be set dynamically)"
    )
    ...
    def get_summary(self) -> dict:
        ...
        sensitive_fields = {'telegram_bot_token', 'openai_api_key', 'telegram_webhook_secret'}
...
class DevelopmentConfig(BaseConfig):
    ...
    ngrok_auth_token: Optional[str] = Field(
        default=None,
        description="ngrok auth token for tunneling"
    )
    auto_setup_webhook: bool = Field(
        default=True,
        description="Automatically set up webhook via ngrok"
    )
...
class ProductionConfig(BaseConfig):
    ...
    telegram_webhook_secret: str = Field(..., description="Webhook secret is required in production")
    telegram_webhook_url: str = Field(..., description="Webhook URL is required in production")
