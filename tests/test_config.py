...
class TestConfigurationLoading:
    ...
    def test_load_production_config_with_required_fields(self):
        ...
        with patch.dict(
            os.environ,
            {
                ...
                "LOG_LEVEL": "INFO",  # Explicitly set log level for production
                "DATABASE_ECHO": "false",  # Explicitly set database echo for production
            },
        ):
            reset_config()
    ...
    def test_load_config_missing_required_fields(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            with patch(
                "src.core.config.CONFIG_CLASSES", {"production": TestProductionConfig}
            ):
